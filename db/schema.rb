...
ActiveRecord::Schema.define(version: 20_161_228_212_306) do
  ...
  create_table 'campaigns_users', force: :cascade do |t|
    ...
    t.integer 'user_id', null: false
    t.index %w[campaign_id user_id], name: 'index_campaigns_users_on_campaign_id_and_user_id', unique: true
  end
  ...
  create_table 'content_texts_users', id: false, force: :cascade do |t|
    ...
    t.index %w[content_text_id user_id], name: 'content_texts_users_uniqueness', unique: true
  ...
  create_table 'hierarchy_elements', force: :cascade do |t|
    ...
    t.index %w[hierarchable_type hierarchable_id], name: 'index_hierachy_elements_on_hierarchable'
  ...
  create_table 'hierarchy_elements_users', id: false, force: :cascade do |t|
    ...
    t.bigint 'user_id', null: false
    t.index %w[hierarchy_element_id user_id], name: 'hierarchy_elements_users_uniqueness', unique: true
